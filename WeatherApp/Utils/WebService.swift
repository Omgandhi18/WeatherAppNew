...
func CallWebService<T: Codable>( Model_Name    : T.Type,
                                URLstr      : String,
                                method      : String = HTTPMethodName.POST.rawValue,
                                parameters  : Parameters? = nil,
                                encoding    : ParameterEncoding = JSONEncoding.default,
                                ...
                                OnFail      :@escaping(String) ->Void)
{
    ...
    if NetworkReachabilityManager()?.isReachable == true {
        AF.request(URLstr,method: HTTPMethod(rawValue: method) ,parameters: parameters,encoding: JSONEncoding.default).validate(statusCode: 200..<300).responseDecodable(of: T.self) { response in
            //MARK: - Dismiss Progress Hud
//            Progress.dismissProgress()
//            if  response.error?.errorDescription != nil {
//                // ---  SHOW ALERT THAT URL NOT VALID OR PARAMETER NOT SEND OR STATUS CODE "400" ETC
